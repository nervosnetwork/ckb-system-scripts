 ...
 * base58(version_ripemd160(sha256(pubkey))_sha256(sha256(version_ripemd160(sha256(pubkey))))[0..4])
 *
 ...
 *
 * ```
 * dependence_code_hash = "0x + this script hash"
 ...
 *
 * Signature generated by your private key sign tx_hash + witness[1:]
 */
